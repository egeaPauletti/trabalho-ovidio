...
export default function Initial() {
  return (
    <section className="w-[90%] max-sm:w-full h-dvh mt-10 flex xl:flex-row sm:flex-col xl:justify-around sm:justify-center items-center text-center gap-15 relative z-90 overflow-hidden fadeInAnimation">
      ...
      <div className="hidden lg:flex xl:flex-col z-50 sm:flex-row">
        <img className="xl:w-90 xl:h-50 max-sm:w-80 max-sm:h-40 md:w-80 md:h-40 rounded-xl rotate-7 relative top-7 z-50" src={panel3} alt="" />
        <img className="xl:w-90 xl:h-50 max-sm:w-80 max-sm:h-40 md:w-80 md:h-40 rounded-xl -rotate-6 z-51" src={panel2} alt="" />
        <img className="xl:w-90 xl:h-50 max-sm:w-80 max-sm:h-40 md:w-80 md:h-40 rounded-xl rotate-5 relative bottom-7 z-50" src={panel1} alt="" />
      </div>
    </section>
  )
}